...
**Работа с виртуальными машинами** (Virtualbox, VMware, Hyper-V, VMware ESXi, Proxmox, YandexCloud, OpenStack) и **физическими серверами** (Linux, Windows Server): samba, pxe, iRedmail, Active Directory, XMPP(ejabberd), web-сервера.
...
– Привёл в порядок автотестовый фреймворк на Python + Pytest + Playwright, разработанный двумя студентами-стажёрами без опыта в автоматизации тестирования. После масштабного рефакторинга проект был приведён к паттерну проектирования Page Object Model (POM);<br>
...
– Впоследствии руководителем было принято решение о смене технологического стека. С нуля разработал новый автотестовый фреймворк на TypeScript + Playwright (паттерн проектирования: Page Object Model);<br><br>
...
<div>
  ...
  <img src="https://iqaengineer.com/wp-content/uploads/2024/06/Fiddler-Logo.png" title="fiddler" alt="fiddler" width="40" height="40"/>&nbsp
</div>
...
<div>
  ...
  <img src="https://thumb.wikimedia.org/wikipedia/commons/thumb/4/4b/Bash_Logo_Colored.svg/960px-Bash_Logo_Colored.svg.png?utm_source=ru.wikipedia.org&utm_campaign=index&utm_content=thumbnail" title="bash" alt="bash" width="40" height="40"/>&nbsp
...
<div>
  ...
  <img src="https://thumb.wikimedia.org/wikipedia/commons/thumb/c/c2/GitHub_Invertocat_Logo.svg/250px-GitHub_Invertocat_Logo.svg.png?utm_source=en.wikipedia.org&utm_campaign=index&utm_content=thumbnail" title="GitHub" alt="GitHub" width="40" height="40"/>&nbsp
